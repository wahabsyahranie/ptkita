...
class WarrantyDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool claimLimitReached =
        warranty.maxClaim != null && warranty.claimCount >= warranty.maxClaim!;
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _infoRow(
                      'Batas Klaim',
                      warranty.maxClaim == null
                          ? 'Tidak terbatas'
                          : '${warranty.maxClaim} kali',
                    ),
                    _divider(),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: warranty.isExpired || claimLimitReached
                      ? null
                      : () {
                          if (warranty.isExpired) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text(
                                  'Masa garansi sudah habis (Expired)',
                                ),
